    ...
    internal sealed class Configuration : DbMigrationsConfiguration<JewelryMaking.Data.ApplicationDbContext>
    {
        ...
        protected override void Seed(JewelryMaking.Data.ApplicationDbContext context)
        {
            ...
            context.Sources.AddOrUpdate(x => x.SourceId,
                ...
                new Source() { SourceId = 5, Name = "Small and Beautiful Beads", WebSite = "https://www.kazuriwest.com", ShowOrLocation = "Gem Street", Address = "13714 Barfield Drive", City = "Warren", State = "MI", ZipCode = "48088", Note = "Tamie Simpson, Email: tamiesimpson111@gmail.com, Phone: 810.919.4386, Now runs Kazuri West" },
                new Source() { SourceId = 6, Name = "Elka Designs", WebSite = "https://www.elka-designs.shoppingcartsplus.com/index.html", ShowOrLocation = "Gem Street", Address = "suite 101, 1098 S.Milwaukee Ave", City = "Wheeling", State = "IL", ZipCode = "60090", Note = "Jolanta, Phone Number: 847-387-2973, Email Address:  pljola7@comcast.net" },
                new Source() { SourceId = 7, Name = "Newtique Beads", WebSite = "", ShowOrLocation = "Gem Street USA", Address = "", City = "Kingsport", State = "TN", ZipCode = "", Note = "Zenda Conerly, newtique@chartertn.net" },
                ...
                new Source() { SourceId = 11, Name = "T & T Trading", WebSite = "http://tttbeads.com", Address = "1063 E Grand Ledge Hwy", City = "Grand Ledge", State = "MI", ZipCode = "48837", Note = " Tom and Theada Howard, Son = Dan, Email: Tom@tttbeads.com, Phone number: 517-627-2333" }
                );
            ...
            context.Locations.AddOrUpdate(x => x.LocationId,
                ...
                new Location() { LocationId = 7, Kind = "RolyKit", Size = "Medium", Color = "Green", Place = "Stack" },
            ...
            context.StringingMaterials.AddOrUpdate(x => x.StringingMaterialId,
                new StringingMaterial() { StringingMaterialId = 1, Type = "Cord", Size = 2, Color = "Black", Length = 1800, Description = "", Cost = 0.13, LocationId = 14, SourceId = 0 },
                new StringingMaterial() { StringingMaterialId = 2, Type = "Cord", Size = 2, Color = "Brown", Length = 1800, Description = "", Cost = 0.13, LocationId = 14, SourceId = 0 },
                new StringingMaterial() { StringingMaterialId = 3, Type = "Cord", Size = 2, Color = "Navy", Length = 180, Description = "Weathered", Cost = 0.25, LocationId = 14, SourceId = 8 },
                new StringingMaterial() { StringingMaterialId = 4, Type = "Cord", Size = 5, Color = "Black", Length = 120, Description = "polished", Cost = 0.35, LocationId = 14, SourceId = 8 },
                new StringingMaterial() { StringingMaterialId = 4, Type = "Cord", Size = 5, Color = "Aqua", Length = 24, Description = "metallic", Cost = 0.35, LocationId = 14, SourceId = 8 }
                );
